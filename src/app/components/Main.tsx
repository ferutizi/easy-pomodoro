      ...
      {modal && 
        <form onSubmit={handleSubmit} className={`flex flex-col gap-4 text-lg ${color}-secondary modal w-80 p-4 h-5/6 rounded-lg justify-between`}>
          <div> {/* Header */}
            ...
            <h2 className="text-white text-lg">Configuration</h2>
          </div>
            ...
            <div className= "flex flex-col gap-4">
              ...
              <div style={{boxShadow: "0px 4px 0.7px rgba(0, 0, 0, 0.25);"}} className={`flex items-center p-2 rounded-lg ${color}-primary`}>
                <label className="flex items-center justify-between w-64 text-white"> Pomodoros
                  <input className={`w-20 h-10 text-3xl text-black rounded text-center ps-3 ${color}-light`} name="pomodoro" type="number" value={timerValue.pomodoro} onChange={handleChange} />
                </label>
              </div>
              <div className={`flex items-center p-2 rounded-lg ${color}-primary`}>
                <label className="flex items-center justify-between w-64 text-white"> Breaks
                  <input className={`w-20 h-10 text-3xl text-black rounded text-center ps-3 ${color}-light`} name="break" type="number" value={timerValue.break} onChange={handleChange} />
                </label>
              </div>
              <div className={`flex items-center p-2 rounded-lg ${color}-primary`}>
                <label className="flex items-center justify-between w-64 text-white"> Long breaks
                  <input className={`w-20 h-10 text-3xl text-black rounded text-center ps-3 ${color}-light`} name="longBreak" type="number" value={timerValue.longBreak} onChange={handleChange} />
                </label>
              </div>
            </div>
            <div> {/* Footer */}
